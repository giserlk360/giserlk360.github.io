...
`);function t(o){e.value=o}return{code:e,updateCode:t}});const F=e=>(Z("data-v-6339e4ff"),e=e(),D(),e),G={class:"experience-editor"},X={class:"experience-editor-header"},q=F(()=>c("div",{class:"experience-editor-header-title"},"\u6E90\u4EE3\u7801\u7F16\u8F91\u5668",-1)),H={class:"experience-editor-header-right"},J={class:"experience-editor-header-right-box"},Q={class:"experience-editor-header-right-box"},ee={class:"experience-editor-header-right-box"},te={__name:"ExperienceEditor",setup(e){const t=window.html_beautify,o=k(),l={autorefresh:!0,smartIndent:!1,tabSize:4,mode:"htmlmixed",theme:"dracula",matchBrackets:!0,lineWrapping:!0,gutters:["CodeMirror-linenumbers","CodeMirror-foldgutter","CodeMirror-lint-markers"],lint:!0,lineNumbers:!0,indentUnit:0,foldGutter:!0,styleActiveLine:!0};let n=b("");const p=m=>{const r=t(m,{indent_size:2});n.value=r},i=()=>{console.log("play"),o.updateCode(n.value)},C=()=>{console.log("copy"),navigator.clipboard.writeText(n.value),O.success("\u590D\u5236\u6210\u529F")},w=(m,r)=>{console.log("\u{1F680} ~ download ~ text:",r);var s=document.createElement("a");s.setAttribute("href","data:text/plain;charset=utf-8,"+encodeURIComponent(r)),s.setAttribute("download",m),s.style.display="none",document.body.appendChild(s),s.click(),document.body.removeChild(s)};return M(()=>{p(o.code)}),(m,r)=>{const s=E;return v(),y("div",G,[c("div",X,[q,c("div",H,[c("div",J,[a(s,{onClick:C},{icon:u(()=>[a(d(P))]),default:u(()=>[f("\u590D\u5236")]),_:1})]),c("div",Q,[a(s,{onClick:i},{icon:u(()=>[a(d(Y))]),default:u(()=>[f("\u8FD0\u884C")]),_:1})]),c("div",ee,[a(s,{onClick:r[0]||(r[0]=_=>w("index.html",d(n)))},{icon:u(()=>[a(d(R))]),default:u(()=>[f("\u4E0B\u8F7D")]),_:1})])])]),a(d(j),{value:d(n),"onUpdate:value":r[1]||(r[1]=_=>N(n)?n.value=_:n=_),options:l,class:"experience-editor-code"},null,8,["value"])])}}},oe=g(te,[["__scopeId","data-v-6339e4ff"]]);const ne={class:"experience-main w-full min-h-[calc(100vh-58px)]"},se=["srcdoc"],ie={__name:"index",setup(e){const t=k();return(o,l)=>(v(),y("div",ne,[a(oe,{class:"w-40%"}),c("iframe",{srcdoc:d(t).code,unselectable:"on",frameborder:"0",scrolling:"no",class:"w-60%",allowfullscreen:""},null,8,se)]))}},ue=g(ie,[["__scopeId","data-v-90991fb3"]]);export{ue as default};
